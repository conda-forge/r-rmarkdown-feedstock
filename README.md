...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-rmarkdown-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rmarkdown-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-rmarkdown
# for installing globally
pixi global install r-rmarkdown
```
...
It is possible to list all of the versions of `r-rmarkdown` available on your platform:
...
```
pixi search r-rmarkdown --channel conda-forge
```
